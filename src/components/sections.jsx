...
export function BoxedTabs({ heading, tabs }) {
  ...
  return (
    <div>
      ...
      <div style={{ border: '1px solid #E6E6E6', borderRadius: 0, background: '#FAFAFA', overflow: 'hidden', display: 'grid', gridTemplateColumns: '0.85fr 1.15fr' }}>
...
export function CardGrid({ cards, cols = 3 }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: `repeat(${cols}, 1fr)`, gap: 20 }}>
      {cards.map((c, i) => (
        <div key={i} style={{ border: '1px solid #E6E6E6', borderRadius: 0, background: '#fff', padding: 28, display: 'flex', flexDirection: 'column' }}>
...
export function LogoGrid({ names }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', border: '1px solid #E6E6E6', borderRadius: 0, overflow: 'hidden' }}>
      {names.map((n, i) => (
        <div key={n} style={{
